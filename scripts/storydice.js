...
const settings = ["an ancient forest", "a catastic city", "a haunted library", "a Minecraft mine", "a mushroom circle in the middle of the woods", "a PAX gaming room", "a brothel", "a Santeria church", "the ninth moon of Endor", "Mars"];
