...
const settings = ["an ancient forest", "a catastic city", "a haunted library", "a Minecraft mine", "a mushroom circle in the middle of the woods", "a PAX gaming room", "a brothel"];
const characters = ["a lost cat", "an ancient sorceress", "a troubled AI", "a one-legged shoemaker named Joe", "a fruit bat with the tail of a skunk and rainbow wings"];
const twists = ["searching for a forgotten tome", "haunted by nightmares", "chased by invisible spirits", "sacrificing a leg to get attention of the fae", "doing something naughty"];
